...
> MCP server for [Threadlinqs Intelligence](https://intel.threadlinqs.com) — 73 tools across threat intelligence, detections, IOCs, threat actors, MITRE attack-chains, C2 infrastructure, and Purple-tier composite intelligence. Drop-in for Claude Code, Claude Desktop, Cursor, and any MCP-compatible client.
...
Sign up at [intel.threadlinqs.com](https://intel.threadlinqs.com), verify your email, and head to **Profile → API Key**. New accounts get a **7-day Purple-tier free trial** that unlocks all 73 tools.
...
New accounts get a **7-day Purple-tier free trial** that unlocks all 73 tools. Tool calls also enforce the tier server-side and return a structured 403 if your subscription lapses.
